...
const COPY = {
  ru: {
    ...
    adjacent: "Показывать соседние префектуры", luckyPlace: "Мне повезёт", luckyHint: "Открыть случайное место из текущей выдачи", resetFilters: "Сбросить фильтры", matchingFilters: "соответствуют фильтрам", visibleOnMap: "видно на карте",
  ...
  ja: {
    ...
    adjacent: "隣接する都道府県も表示", luckyPlace: "おまかせ", luckyHint: "現在の候補からランダムに場所を開く", resetFilters: "フィルターをリセット", matchingFilters: "件が条件に一致", visibleOnMap: "件を地図に表示",
  ...
  en: {
    ...
    adjacent: "Show adjacent prefectures", luckyPlace: "I’m feeling lucky", luckyHint: "Open a random place from the current results", resetFilters: "Reset filters", matchingFilters: "match the filters", visibleOnMap: "visible on the map",
